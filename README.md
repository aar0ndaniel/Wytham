...
SMTP remains as a fallback for environments that allow outbound SMTP ports. The sender fills `signup-beta-email-template.html`; production email uses a text Metis wordmark and does not embed logo images.
