...
function run() {
  ...
  assert.match(dashboardHtml, /Adoption 5\/5/i);
  assert.match(dashboardHtml, /PU 4\.5\/5/i);
  assert.match(dashboardHtml, /PEOU 3\.5\/5/i);
  assert.match(dashboardHtml, /ATT 4\.7\/5/i);
  assert.match(dashboardHtml, /BI 4\.5\/5/i);
  assert.match(dashboardHtml, /Use intent/i);
  assert.match(dashboardHtml, /Best feature/i);
  assert.match(dashboardHtml, /Most valuable/i);
